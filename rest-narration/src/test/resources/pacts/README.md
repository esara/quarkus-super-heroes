...
It would be simple enough to modify [`ContractVerificationTests.java`](../../java/io/quarkus/workshop/superheroes/narration/ContractVerificationTests.java) to use a Pact broker:
