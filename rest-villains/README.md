...
|------------------------|-------------|----------------|-----------------|-------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------|
| `/api/villains`        | `GET`       | `name_filter`  | `200`           | [`List<Villain>`](src/main/java/io/quarkus/workshop/superheroes/villain/Villain.java) | All Villains. Empty array (`[]`) if none. Optional `name_filter` query parameter for filtering results by name (case-insensitive). |
...
| `/api/villains/random` | `GET`       |                | `200`           | [`Villain`](src/main/java/io/quarkus/workshop/superheroes/villain/Villain.java)       | Random Villain                                                                                                                     |
| `/api/villains/random` | `GET`       |                | `404`           |                                                                                     | No Villain found                                                                                                                   |
| `/api/villains/{id}`   | `GET`       |                | `200`           | [`Villain`](src/main/java/io/quarkus/workshop/superheroes/villain/Villain.java)       | Villain with id == `{id}`                                                                                                          |
...
| `/api/villains/{id}`   | `PATCH`     |                | `200`           | [`Villain`](src/main/java/io/quarkus/workshop/superheroes/villain/Villain.java)       | Partially updates a Villain. Returns the complete Villain.                                                                         |
...
Pre-built images for this application can be found at [`esara/ui-super-heroes`](https://hub.docker.com/repositories/esara/rest-villains?tab=tags). 
