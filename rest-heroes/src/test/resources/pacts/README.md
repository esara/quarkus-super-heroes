...
It would be simple enough to modify [`ContractVerificationTests.java`](../../java/io/quarkus/workshop/superheroes/hero/ContractVerificationTests.java) to use a Pact broker:
