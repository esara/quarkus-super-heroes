...
public interface FightMapper {
  /**
   * Maps all fields from {@code fight} to a {@link io.quarkus.workshop.superheroes.fight.schema.Fight}
   * @param fight
   * @return
   */
  io.quarkus.workshop.superheroes.fight.schema.Fight toSchema(Fight fight);
