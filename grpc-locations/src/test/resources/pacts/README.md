...
It would be simple enough to modify [`ContractVerificationTests.kt`](../../kotlin/io/quarkus/workshop/superheroes/location/ContractVerificationTests.kt) to use a Pact broker:
