...
There is also a container image available that you can use instead:
 ...
 ```bash
docker run -p 8080:8080 -e API_BASE_URL=http://localhost:8082 esara/ui-super-heroes:latest
```

## Running Locally via Docker Compose
Pre-built images for this application can be found at [`esara/ui-super-heroes`](https://hub.docker.com/repositories/esara/ui-super-heroes?tab=tags).

The application can be started outside of docker compose simply with `docker run -p 8080:8080 esara/ui-super-heroes:latest`.
...
Pre-built images for this application can be found at [`esara`](https://hub.docker.com/repositories/esara/ui-super-heroes?tab=tags).
